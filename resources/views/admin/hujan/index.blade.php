                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Sensor Hujan</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <table class="table" id="tabel">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Nilai Data Sensor</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.data.length === undefined) {
                    tableData = "<tr><td colspan='4' class='text-center'>Data tidak tersedia</td></tr>";
                } else {
            ...
            complete: function() {
                ...
                setTimeout(fetchData, 500); // Mengambil data setiap 5 detik (ganti sesuai kebutuhan Anda)
            }
        });
    }
